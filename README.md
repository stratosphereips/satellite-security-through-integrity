...
ADDITIONAL RESTRICTION (per GPL v2 Section 7): This software may not be used, in whole or in part, for commercial purposes without prior written permission from the copyright holder. Commercial use includes, but is not limited to, use in a commercial product, use in a service offered for a fee, or use by a for-profit organization.
